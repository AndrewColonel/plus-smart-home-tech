...
public class DeviceAddedEventAvroSerializer implements Serializer<DeviceAddedEventAvro> {
    private static final Logger log = LoggerFactory.getLogger(DeviceAddedEventAvro.class);
